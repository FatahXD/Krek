...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            FinoDafaresta
\033[1;37m Facebook:         Giselle Lambert
\033[1;37m Github  :            FinnGITHUB01
\033[1;37m Version :            4.5
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    print(f'[W] WhatsApp Admin ')
    print(f'[F] Join Telegram admin ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open wa.me/62838324863130')
        pass
    elif select =='F':
        os.system('xdg-open https://t.me/SCALLPRIB')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
