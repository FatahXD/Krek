...
def menu():   
    clear()
    print(f'{G1}[{A}1{G1}]{G1} CRACK PUBLIK 100% DAPAT')
    print(f'{G1}[{A}2{G2}]{G2} RADMON CRACK BISA DPT GG')
    print(f'{G1}[{A}3{G3}]{G3} KONTAK ADMIN FINO GANTENG')
    ...
    if select =='1':
        ...
        os.system('xdg-open wa.me/62838324863130');menu()
    elif select =='0':
...
def _randm_():   
    clear()
    print(f'{G1}[{A}1{G1}]{G1} FF GG ')
    print(f'{G1}[{A}2{G2}]{G2} ML GG')
    print(f'{G1}[{A}0{G3}]{G3} KEMBALI KE AWAL')
    linex()
    select = input(f'{G1}[{A}?{G5}]{G5} CHOICE {A}:{G5} ')
    if select =='1':
        _bd_()
...
def _file_():
    global methods
    clear()
    print(f'{G1}[{A}1{G1}]{G1} FINO V1{G1}[{A}M1{G1}]{G1} ')
    print(f'{G1}[{A}2{G2}]{G2} FINO V2 {G2}[{A}M2{G2}]{G1} ')
    linex()
