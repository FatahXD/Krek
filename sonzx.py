...
for t in range(10000):
	...
	kondom3=f'Mozilla/5.0 (iPhone; CPU iPhone OS {iphone} like Mac OS X) AppleWebKit/{iphone1} (KHTML, like Gecko) Version/14.0.{k} Mobile/{iphone2} Safari/60{k}.1'
