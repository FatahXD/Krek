...
for ut in range(10000):
    rafmkz = f'Mozilla/5.0 (Linux; Android 8.0.0; LLD-L31 Build/HONORLLD-L31; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 7.0; KOB-L09) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 7.1.2; Aquaris U2 Lite) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 6.0; MEIZU_M5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 7.0; BQ-5059) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 5.1; m3 note) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 6.0.1; NX551J) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 8.0.0; SM-N950U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 8.0.0; SM-J600GT Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 4.4.2; HTC Desire 510 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; Android 6.0.1; SM-C5000 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Safari/537.36'
    ugen.append(rafmkz) 
    
    rafmkz = f'Mozilla/5.0 (Linux; U; Android 7.0; 4047D Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36 OPR/21.0.2254.111678'
    ugen.append(rafmkz)      
...
def dump():    
	...
	for user in uid:
	    try:
	       head = (
	       {"user-agent": "Mozilla/5.0 (Linux; Android 13; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Mobile Safari/537.36"
	       })
	       if len(id) == 0:
	           params = (
	           {
